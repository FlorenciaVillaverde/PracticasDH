window.addEventListener("load", function() {
    ...
    Utilizando un ciclo for recorrer el array data y por cada elemento del array ejecutar un innerHTML pra 
    agregar un encabezado h2 con el titulo del producto. */
    ...
    for (let index = 0; index < data.length; index++) {
        ...
        document.querySelector(".grid-container").innerHTML += "<h2>" + element.name + "</h2>"
    }



    /*4- Ahora que ya podemos insertar datos en el HTML te vamos a pedir que utilizando un ciclo forEach recorras el array
    data e insertes en el section con la clase "grid-container" una etiqueta article con la clase "box" + un h2 con el nombre 
    del producto + una imagen con la clase "box-img" + un h3 con el precio del producto y una etiqueta p con su descripcion. */
    ...
    for (let index = 0; index < data.length; index++) {
        ...
        document.querySelector(".grid-container").innerHTML += "<a href='detalle.html?id=" + element.id + "'>" + element.name +"</a>"
    }
